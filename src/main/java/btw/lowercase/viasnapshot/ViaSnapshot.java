...
import btw.lowercase.viasnapshot.protocol.v25w02ato1_21_4.*;
import btw.lowercase.viasnapshot.protocol.v25w03ato1_21_4.*;
import btw.lowercase.viasnapshot.protocol.v25w04ato1_21_4.*;
...
public class ViaSnapshot extends ViaProxyPlugin {
    ...
    private void onInitializeEvent(ProtocolTranslatorInitEvent event) {
        event.registerPlatform(() -> {
            ...
            protocolManager.registerProtocol(new Protocol25w04ato1_21_4(), SnapshotProtocolVersion.v25w04a, ProtocolVersion.v1_21_4);
            protocolManager.registerProtocol(new Protocol25w03ato1_21_4(), SnapshotProtocolVersion.v25w03a, ProtocolVersion.v1_21_4);
